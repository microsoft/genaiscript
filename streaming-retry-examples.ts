...
/*
This is a conceptual example showing how the streaming retry logic would behave
in real scenarios. The actual implementation is integrated into the OpenAI and
Anthropic chat completion handlers.
*/

interface StreamingRetryExample {
    scenario: string
    initialResponse: {
        text: string
        finishReason: "fail" | "stop" | "length" | "tool_calls"
...
const examples: StreamingRetryExample[] = [
    {
...
function shouldRetryStreaming(response: StreamingRetryExample['initialResponse'], attempt: number, maxRetries: number): boolean {
...
export { examples, shouldRetryStreaming }