...
function turnoffN() {
    const rules = {};
    for (const rule of Object.keys(eslint_plugin_n_1.default.rules ?? {})) {
        rules[`n/${rule}`] = "off";
    }
    return rules;
}
...
exports.default = (parser) => [
    ...
    eslint_plugin_n_1.default.configs["flat/recommended"],
    nCustomization,
    nOffForBrowser,
];
//# sourceMappingURL=genaiscript-customized.js.map