 ...
 */
export const stripPath = (pathOrFileName) => pathOrFileName.replace(/^.*[\\\/]/, "");
/**
 ...
 */
export function isEsmPackage(filePath) {
 ...
 */
export const stripFileName = (pathOrFileName) => pathOrFileName.replace(/[\\\/][^\\\/]+$/, "");
/**
 * Converts an array to its literal string representation.
 * @param array the array in question.
 * @returns the array's string representation.
 */
export const arrayToString = (array) => JSON.stringify(array).replace(/,/g, ", ");
/**
 ...
 */
export const getVerifiers = (context, data) => ({
    /**
