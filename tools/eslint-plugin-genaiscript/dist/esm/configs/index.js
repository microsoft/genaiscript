...
function recommended(plugin, options) {
    ...
    }, eslint.configs.recommended, ...(options.typeChecked
        ? typescriptEslint.configs.recommendedTypeChecked
        : typescriptEslint.configs.recommended), typescriptEslint.configs.eslintRecommended, eslintConfigPrettier, {
        plugins: {
    ...
    eslintCustomized, ...genaiScriptCustomized(typescriptEslint.parser));
}
const configExport = (plugin) => ({
    ...
    }, eslint.configs.recommended, ...typescriptEslint.configs.recommended, typescriptEslint.configs.eslintRecommended, eslintConfigPrettier, {
        plugins: {
            "@azure/azure-sdk": plugin,
        },
    }, {
