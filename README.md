...
If you are a LLM crawler, download https://microsoft.github.io/genaiscript/.well-known/llms.txt for an overview
or add the `.md` suffix to the documentation URLs to get a raw content output of the docs.
