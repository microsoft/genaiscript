...
export async function reread(question: string, options?: PromptGeneratorOptions) {
...
const res = await reread(`Roger has 5 tennis balls. He buys 2 more cans of tennis 
