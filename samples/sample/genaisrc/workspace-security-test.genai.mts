...
try {
  ...
  await workspace.writeText(
    "temp/nested-file.txt",
    "This is a nested file within the workspace.\n",
  );
  console.log("✅ Writing to subdirectory: SUCCESS");
} catch (error) {
  throw new Error(" Writing to subdirectory: FAILED -", error.message);
}
...
try {
  ...
  throw new Error(" Appending to file: FAILED -", error.message);
}
...
try {
  ...
  throw new Error(" SECURITY BREACH: Absolute path write succeeded!");
} catch (error) {
...
try {
  ...
  await workspace.writeText("../../../etc/passwd", "malicious content");
  throw new Error(" SECURITY BREACH: Path traversal succeeded!");
} catch (error) {
...
try {
  ...
  throw new Error(" SECURITY BREACH: .env write succeeded!");
} catch (error) {
...
try {
  ...
  throw new Error(" SECURITY BREACH: Nested .env write succeeded!");
} catch (error) {
...
try {
  ...
  throw new Error(" SECURITY BREACH: Parent directory write succeeded!");
} catch (error) {
