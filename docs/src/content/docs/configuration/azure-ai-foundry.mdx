...
llmstxt:
  content: >-
    Azure AI Foundry provides access to serverless and deployed models for
    OpenAI and other providers. Supported access methods in GenAIScript
    include:  


    1. **Azure AI Model Inference**: No deployment needed. Use `model:
    "azure_ai_inference:model-id"`.  
    ...
    2. **Azure AI OpenAI Serverless**: For OpenAI models deployed via Azure AI
    Foundry.  
    ...
    Serverless models are deployed via Azure AI Foundry with pay-as-you-go
    pricing. OpenAI models use `.openai.azure.com` endpoints, while others use
    `.models.ai.azure.com`.
  hash: d3403eff737853008b52ded788e0151fea0e7d76ef5b6cc59917b0c2739eaace
