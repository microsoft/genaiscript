...
[Agentic](https://agentic.so) (([GitHub](https://github.com/transitive-bullshit/agentic))) is a standard library of AI functions / tools 
...
Among others, you will find tools for: [Bing]()
...
-  [Core](https://agentic.so/tools/core)
...
-  [Stdlib](https://agentic.so/tools/stdlib)
