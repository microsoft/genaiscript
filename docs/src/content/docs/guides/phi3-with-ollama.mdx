...
sidebar:
    order: 10
description: Learn how to integrate Phi-3 Mini, a powerful 3.8B parameter model by Microsoft, with Ollama for local execution of state-of-the-art AI models.
...
```js title="summarize-phi3.genai.js" "ollama:phi3"
script({
    model: "ollama:phi3",
