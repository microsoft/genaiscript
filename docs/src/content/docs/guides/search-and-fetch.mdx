...
llmstxt:
  content: >-
    Use the `> GenAIScript: Create new script...` command to create a script for
    planning a weekend trip. Define the script with a title, description, and
    model:
    ...
    $`You are a helpful assistant for planning weekend trips. Using PARKINFO and
    ${weather}, plan a weekend trip starting tomorrow.`

    ```


    Run the script to generate a detailed weekend plan. The output will include
    an itinerary based on destination details and weather conditions.
  hash: 3be96df441b27d6ff768e6704df3935cc7ae0863076bf8f1fbccee09a74f9d4f
