...
search for information about the destination. Note that the use `webSearch` you will need a Bing Web Search API key. 
    ...
    ```
4. `webSearch` returns a list of URLs.  Use Use [`fetchText`](/genaiscript/reference/scripts/fetch/)
