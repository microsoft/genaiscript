...
llmstxt:
  content: >-
    Define tools to enable an LLM agent to perform arithmetic operations like
    sum and divide. Tools are declared with a name, description, schema, and
    ...
    defTool("divide", "Divide two numbers", { a: 1, b: 2 }, ({ a, b }) => `${a /
    b}`)
    ...
    Alternatively, use `system.math` to simplify by leveraging a built-in math
    parser tool, removing the need to define tools manually.
  hash: 6021553f47f6ecbee5e0037dff883b250546ed831b4885632739cd334c0b300a
