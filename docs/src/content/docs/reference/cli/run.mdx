...
llmstxt:
  content: >-
    ...
    - `file://` (local), `https://github.com/...` (GitHub), `gist://id/...`
    (Gist), `git://...` (Git repo).  
    ...
    Remote scripts: Use `--remote <owner>/<repo>` to run scripts from a remote
    repo.


    Pull Requests/Issues:  

    - GitHub Actions: Add `pull-requests: write` permission and set
    `GITHUB_TOKEN`.  

    - Azure DevOps: Add `<projectname> Build Service` as Collaborator and pass
    `System.AccessToken`.
  ...
  hash: 69cff6e3cb6b4b267f5b109b97ff05f08f9b668e82f0fc2e1e07912ddaa0c113
