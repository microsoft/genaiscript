...
sidebar:
  order: 100
description: Explore the features of the Markdown Notebook for authoring documentation with script snippets and inline results.
keywords: Markdown Notebook, documentation authoring, script snippets, inline results, experimental features
genaiscript:
