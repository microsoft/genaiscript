...
llmstxt:
  content: >-
    GenAIScript supports user input functions for interactive scripts. In CLI,
    ...
    `const choice = await host.select("Choose an option:", ["Option 1", "Option
    2", "Option 3"])`


    In CI environments, these functions return `undefined`.
  hash: 5eab99a93a15aad19516947916f09078c318fcf2ab089f4c351bf00bccc458db
