...
llmstxt:
  content: >-
    ...
    `gpt-4o`). Use `defImages` to declare images, supporting formats like PNG,
    JPEG, WEBP, and GIF. Both URLs and local files are allowed.
    ...
    Local files are encoded as data URIs. Buffers, Blobs, and ReadableStreams
    ...
    - **Max Dimensions**: Resize to fit constraints.
      ...
      ```
  hash: a2b934f9d4a57a9833710712a6eed8e048f47787966578a0c9638cbb4ff1b00c
