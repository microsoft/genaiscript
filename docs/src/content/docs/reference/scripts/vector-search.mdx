...
llmstxt:
  content: >-
    GenAIScript supports vector database integration for embeddings search and
    retrieval-augmented generation (RAG). 


    To create or load an index, use `retrieval.index`. Options must remain
    ...
    By default, vectors are stored locally in `.genais
  hash: a8ae796d4b165474d50a783bf9bffee15bccd7222e181a69645d6c81a08b00f3
