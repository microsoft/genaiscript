...
-  tool `mcp_read_resource`: Read the content of a resource from a URL. Resolves various protocols and returns the content of the files found at the URL.

`````js wrap title="system.mcp_read_resource"
system({
