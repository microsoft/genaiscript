...
- [system.safety_upload_assets](/genaiscript/reference/scripts/system#systemsafety_upload_assets) safety validation for file upload operations, scanning for secrets and harmful content
...
- [system.safety_upload_assets](/genaiscript/reference/scripts/system#systemsafety_upload_assets) validates file upload operations for secrets and harmful content before upload.
