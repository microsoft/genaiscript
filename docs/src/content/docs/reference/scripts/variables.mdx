...
llmstxt:
  content: >-
    The `env.vars` object stores variable values for parameterizing scripts. Use
    `env.vars` to set defaults or modify behavior dynamically. Example:
    ...
    Declare parameters in the `script` function. `env.vars` will hold their
    values:
    ...
    ```
  hash: 2e0bd89065ac1d1101c129c9f5500d4870d851ef79c99dd4dc0311abdb975008
