...
The `z3` tool (in [system.z3](/genaiscript/reference/scripts/systems#systemz3)) script wraps Z3 as a LLM tool that can be used in GenAIScript.
...
The `z3` agent (in [system.agent-z3](/genaiscript/reference/scripts/systems#systemagent-z3)) script wraps the `z3`
