...
There are many viewers for OpenTelemetry.
If you want to try out the telemetry locally, you can try to launch a [standalone Aspire Dashboard](https://learn.microsoft.com/en-us/dotnet/aspire/fundamentals/dashboard/standalone?tabs=bash) instance with Docker.
