...
If you want to try out the telemetry locally, launch a [Aspire dashboard](https://learn.microsoft.com/en-us/dotnet/core/diagnostics/observability-otlp-example#7-start-the-aspire-dashboard-container) instance with Docker.
