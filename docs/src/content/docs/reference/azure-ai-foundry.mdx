...
- [Azure AI Inference](/genaiscript/getting-started/configuration#azure_ai_inference)
- [Azure OpenAI Serverless](/genaiscript/getting-started/configuration#azure_openai_serverless)
...
- [Configuration](/genaiscript/getting-started/configuration#azure_ai_search)
