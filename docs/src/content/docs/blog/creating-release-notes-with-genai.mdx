...
description:
  Learn how to automate the creation of engaging software release
  notes using GenAI and GenAIScript.
cover:
  alt:
    "A retro 8-bit visual scene illustrates an automated release notes process
...
excerpt:
  Crafting effective release notes can be a time-consuming process, but
