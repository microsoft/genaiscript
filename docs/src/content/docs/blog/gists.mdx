...
cover:
  ...
  image: ./gists.png
excerpt: GitHub Gists simplify script sharing and reuse, and tools like GistPad
  for VS Code take it a step further by enabling direct creation and management
  within your editor. Learn how to integrate these workflows and boost
