...
llmstxt:
  content: >-
    GenAIScript enables automated web page content analysis using the Playwright
    library for browser automation. Here's a streamlined example:
    ...
    The `browse` function initializes a browser session and loads the specified
    URL.
    ...
    This script automates tasks like content extraction, visual archiving, and
    AI analysis, making it ideal for audits, competitive research, or content
    insights.
  hash: bca40fa02811e8c55902a8b9e14cea0d673dac991aac642bdb7721a042f7c54b
