...
llmstxt:
  content: >-
    [Tools] enable LLMs to use external tools for enhanced reasoning. Some
    models, like OpenAI's o1-preview and o1-mini, lack native tool support.


    Fallback tools, introduced in GenAIScript 1.72.0, teach LLMs about available
    tools and their usage via system scripts. Example:
    ...
    Fallback tools activate automatically for unsupported models. To enable
    manually:
    ...
    ```
  hash: a0495dce78b2f17e5a69d1493aaa4b38def2a9651ec30f10ef9f5eb1f9a84b1a
