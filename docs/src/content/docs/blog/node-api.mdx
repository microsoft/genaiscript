...
cover:
  ...
  image: ./node-api.png
excerpt: "Now available: a Node.js API for GenAIScript. This update lets you
  integrate GenAIScript directly into your TypeScript projects, offering the
  same functionality as the CLI. With a side-effect-free implementation and
  minimal resource usage, it’s built for seamless, efficient workflows. Ready to
  try it? Dive into the documentation for details."
