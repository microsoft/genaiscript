...
excerpt: Discover the 2025 updates to GenAIScript, introducing a self-hosted
  Playground interface for running scripts with ease! The release also expands
  support for models like OpenAI's o1 and DeepSeek V3, integrating seamlessly
  with their APIs. Explore how these enhancements simplify workflows and enhance
