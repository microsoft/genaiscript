...
llmstxt:
  content: >-
    Need to search and transform patterns across multiple files in your project?
    Automate this tedious task with a GenAIScript. For instance, when updating
    the `exec` command to support string commands, scripts like:
    ...
    The [Search And Transform guide](/genaiscript/guides/search-and-transform)
    provides detailed steps for this approach. Save time and streamline updates
    with automation.
  hash: 8f76e553c9b45a99600e3b72e76ba2af293272371a67d5c20b898050a4d9c0f0
