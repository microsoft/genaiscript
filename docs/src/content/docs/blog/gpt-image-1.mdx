...
llmstxt:
  content: >-
    Support for OpenAI's `gpt-image-1` model has been added, enabling advanced
    image generation via OpenAI's API or Azure AI Foundry. Example usage:
    ...
    A comparison script generates an 8-bit pixelated cat image across models
  ...
  hash: 2fb6bf4bb2631afd15f8934c294a66fac32a21051358907bec7ed64dd7c69c82
