...
llmstxt:
  content: >-
    GenAIScript includes a `makeItBetter` function to improve code by iterating
    ...
    To execute, run `genaiscript run makeitbetter` in the terminal. For setup
    details, refer to the GenAIScript documentation. This process leverages AI
    to refine code efficiently.
  hash: a1413428d3a9cb3f488759481c1a02c4314f240ee627a8c45bbb23559cbe6ba4
