...
- with deployment for OpenAI models, using the [Azure AI OpenAI Serverless](#azure_serverless_openai) provider,
...
```js "azure_ai_inference:"
script({ model: "azure_ai_inference:gpt-4o" })
```

#### Managed Identity (Entra ID) -- Under contrusctions

:::note

This authentication method is not yet supported.
...
Open https://ai.azure.com/, open your project and go the **Management center**.
...
Add your user or service principal to the **Azure AI Developer** role.
