...
If you are using Visual Studio Code, the extension will ask you to sign in and select the subscription.
To skip the subscription selection, you can set the `AZURE_SUBSCRIPTION_ID` environment variable.
