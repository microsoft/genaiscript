...
Otherwise, update the `.env` file with the [GitHub personal access token](https://github.com/settings/tokens/new).
...
## GitHub Copilot Models <a id="github-copilot" href=""></a>
...
Install [GitHub Copilot Chat](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot-chat)
