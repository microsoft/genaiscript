...
it is included here. It allows you to do vector search of your documents using [Azure AI Search](https://learn.microsoft.com/en-us/azure/search/search-what-is-azure-search) service.
