...
[Ollama](https://ollama.ai/) are desktop application that let you download and run model locally.
...
Pull your model from the Ollama server (see [list of models](https://ollama.com/library)).
