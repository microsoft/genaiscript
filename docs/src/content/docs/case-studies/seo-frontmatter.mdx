...
```bash
node .genaiscript/genaiscript.cjs batch front-matter src/**/*.md --apply-edits
```
...
```json title="package.json"
{
  ...
  "scripts": {
    "genai:frontmatter": "node .genaiscript/genaiscript.cjs batch front-matter src/**/*.md --apply-edits",
  }
}
```
