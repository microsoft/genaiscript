...
sidebar:
  order: 5
description: Explore the challenges and solutions for localizing MakeCode documentation with custom macros while maintaining rich rendering in multiple languages.
keywords: localization, MakeCode, translation automation, documentation translation, multilingual support
---
