...
```sh
node .genaiscript/genaiscript.cjs run translate ... --vars lang=German
```

### Validation and upload

The CLI can be automated using your favorite bash/script runtime.
For example, using [2024-03-11-15-59-15.png2024-03-11-16-00-53.png2024-03-11-16-01-31.pngzx](https://google.github.io/zx/), we automate for a number of locales:
...
for(const lang of langs) {
    ...
    await $`node .genaiscript/genaiscript.cjs run translate ... --vars lang=${lang} ... --apply-edits`
