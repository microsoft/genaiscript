...
description: Générer du texte alternatif pour les images dans les fichiers markdown
sidebar:
  order: 5
...
## Source complète ([GitHub](https://github.com/microsoft/genaiscript/blob/main/samples/sample/genaisrc/samples/iat.genai.mts))
