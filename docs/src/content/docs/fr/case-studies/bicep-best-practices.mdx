---
title: Pratiques exemplaires pour Bicep
sidebar:
  order: 2
description: Apprenez comment appliquer les meilleures pratiques aux fichiers
  Azure Bicep pour une infrastructure en tant que code plus efficace et plus
  facile à maintenir.
...
* le script utilise un support intégré pour les [annotations](/genaiscript/reference/scripts/annotations)
