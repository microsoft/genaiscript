...
Une fois le script ajusté sur quelques fichiers, vous pouvez automatiser son utilisation avec la [CLI](/genaiscript/reference/cli). La CLI dispose d'un indicateur **--apply-edits** pour appliquer les modifications au fichier.
