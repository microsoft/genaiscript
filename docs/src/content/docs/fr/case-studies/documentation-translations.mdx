---
title: Traductions de la documentation
sidebar:
  order: 5
description: Découvrez les défis et les solutions pour localiser la
  documentation MakeCode avec des macros personnalisées tout en maintenant un
  rendu riche dans plusieurs langues.
...
Notez que nous utilisons la [variable](/genaiscript/reference/scripts/variables) `env.vargs.lang` qui permet de modifier cette valeur via la ligne de commande.
