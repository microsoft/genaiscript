...
#### ───#### Step 1: Initializing the Script```javascript
...
#### ───#### Step 2: Setting the Product Name```javascript
...
#### ───#### Step 3: Finding the Previous Tag```javascript
...
#### ───#### Step 4: Gathering Commits```javascript
...
#### ───#### Step 5: Obtaining the Diff```javascript
...
#### ───#### Step 6: Defining Placeholders```javascript
...
We define two placeholders, `COMMITS`et `DIFF`, which will be used to reference the commits and diff within the prompt.

#### ───#### Step 7: Writing the Prompt```javascript
$`
