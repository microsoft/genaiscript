...
Si vous souhaitez plonger directement dans le script, il est disponible sur GitHub juste [ici](https://github.com/microsoft/genaiscript/blob/main/samples/sample/genaisrc/git-release-notes.genai.mjs).

> Cet article de blog a été coécrit avec un [script](https://github.com/microsoft/genaiscript/blob/main/samples/sample/genaisrc/blogify-sample.genai.mts).
