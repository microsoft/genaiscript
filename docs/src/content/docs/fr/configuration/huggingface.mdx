...
Vous pouvez activer les [espaces de noms de journalisation](/genaiscript/reference/scripts/logging) `genaiscript:huggingface` et `genaiscript:huggingface:msg` pour obtenir plus d'informations sur les requêtes et réponses :
