---
title: Partage de scripts
description: Apprenez comment partager des scripts GenAIScript entre projets en
  utilisant des dépôts Git, des sous-modules et des Gists GitHub.
