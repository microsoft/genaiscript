---
title: Présentez Mon Code
description: Instructions étape par étape pour présenter efficacement du code en
  utilisant GenAIScript et créer des diapositives attrayantes.
