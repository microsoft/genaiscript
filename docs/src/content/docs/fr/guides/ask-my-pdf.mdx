---
title: Demander Mon PDF
description: Guide de démarrage rapide pour utiliser GenAIScript afin de résumer
  et de critiquer des documents PDF avec l'assistance de l'IA.
