...
Vous pouvez lancer le [cli](/genaiscript/reference/cli) en tant que **serveur Web API** pour exposer les scripts en tant que points de terminaison REST.
...
Les paramètres des points de terminaison OpenAPI sont déduits automatiquement à partir des [paramètres du script](/genaiscript/reference/scripts/parameters) et des fichiers.
