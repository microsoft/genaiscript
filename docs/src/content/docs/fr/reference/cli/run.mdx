...
### `--out-trace` *Émet des journaux des modifications dans le fichier spécifié en texte.*
...
### `--out-annotations` *Émet des journaux des modifications dans le fichier spécifié en texte.*
...
### `--out-data` *Émet des journaux des modifications dans le fichier spécifié en texte.*
...
### `--out-changelogs` *Émet des journaux des modifications dans le fichier spécifié en texte.*
...
## Pull Requests et Issues <a href="" id="pull-requests" />
...
Crée des commentaires de revue de pull request à partir de chaque [annotation](/genaiscript/reference/scripts/annotations) ([exemple](https://github.com/microsoft/genaiscript/pull/564#pullrequestreview-2151692644)).
...
La liste complète des options est disponible dans la [référence CLI](/genaiscript/reference/cli/commands#run).
