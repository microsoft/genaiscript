...
Vous pouvez remplacer les modèles utilisés pour les tests à l’aide de `--models` :
...
:::note
Cette fonctionnalité nécessite d’ajouter `@genaiscript/api` à vos dépendances dans `package.json`.
:::
