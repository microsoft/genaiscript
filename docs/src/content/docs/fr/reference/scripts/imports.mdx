...
sidebar:
  order: 20
description: Découvrez comment activer les importations de modules dans les
  scripts GenAI en les convertissant au format .mjs et en utilisant des
  importations statiques ou dynamiques.
...
hero:
  image:
    ...
    file: ../../../reference/scripts/imports.png
