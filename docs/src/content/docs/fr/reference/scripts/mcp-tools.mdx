---
title: Outils du protocole Model Context
sidebar:
  order: 5.09
description: Apprenez à configurer et à utiliser en toute sécurité les outils et
  serveurs du protocole Model Context (MCP), y compris la validation des sorties
  d'outils, la détection de secrets et les meilleures pratiques de sécurité pour
  les scripts d'IA.
keywords:
...
hero:
  image:
    ...
    file: ../../../reference/scripts/mcp-tools.png
