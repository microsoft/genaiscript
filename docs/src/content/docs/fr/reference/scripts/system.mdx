---
title: Invites Système
sidebar:
  order: 10
description: Apprenez à utiliser les invites système pour améliorer l'exécution
  des scripts dans GenAIScript.
...
Résout les systèmes de contraintes en utilisant le solveur de contraintes Z3.

* outil `z3` : résout un problème SMTLIB2 en utilisant le solveur de contraintes Z3. Envoyez les problèmes un par un. Utilisez cet outil si vous avez besoin d'exécuter Z3.
