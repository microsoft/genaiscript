---
title: Invite intégrées
sidebar:
  order: 10
description: Apprenez à utiliser les invites intégrées avec la fonction
  runPrompt pour les invocations internes de LLM dans les scripts.
...
hero:
  image:
    alt: "A flat, 8-bit style digital illustration in 128x128 format, featuring a
      ...
      effects."
    file: ../../../reference/scripts/inline-prompts.png
