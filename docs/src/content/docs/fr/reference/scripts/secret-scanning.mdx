---
title: Analyse des secrets
sidebar:
  order: 10
description: Apprenez à détecter et prévenir les fuites d'informations sensibles
  dans votre base de code grâce à l'analyse automatisée des secrets, des motifs
  personnalisables et des options de configuration.
keywords:
  - secret scanning
  - code security
  - pattern detection
...
hero:
  image:
    ...
    file: ../../../reference/scripts/secret-scanning.png
