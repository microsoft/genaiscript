---
title: Vidéos comme Entrées
description: Comment utiliser la vidéo dans les scripts
sidebar:
  order: 10.01
hero:
  image:
    ...
    file: ../../../reference/scripts/videos.png
...
* spécifiez la transcription calculée par la fonction [transcribe](/genaiscript/reference/scripts/transcription). GenAIScript extraira une image au début de chaque segment.
...
La conversion vers l’audio se fait automatiquement pour les vidéos lors de l’utilisation de [transcribe](/genaiscript/reference/scripts/transcription).
...
Le [cli](/genaiscript/reference/cli/video) prend en charge diverses commandes pour exécuter les transformations vidéo.
