---
title: Serveur du Protocole de Contexte Modèle
sidebar:
  order: 5.1
description: Transforme des scripts en outils du Protocole de Contexte Modèle
hero:
  image:
    ...
    file: ../../../reference/scripts/mcp-server.png
