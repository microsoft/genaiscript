...
llmstxt:
  content: >-
    The script "Universal Linter" automates reviewing code and natural language
    files for correctness and style using GenAIScript and a large AI model. It
    identifies issues and integrates with IDEs for error/warning display. 
    ...
    - Code files: Applies best practices for the specific language (e.g., Python
    for `.py` files).
    ...
    You are Linty, a linter for all known programming and natural languages.
    Review FILE content and report warnings/errors.
  ...
  hash: cbe3979ccbb7d7b50a23e2ac5ac340269a3c3d7ad5580ceaeae346dbf9a57c73
