...
Edit, [debug](/genaiscript/getting-started/debugging-scripts/), [run](/genaiscript/getting-started/run-scripts/) your scripts in the [Visual Studio Code](/genaiscript/getting-started/installation).
