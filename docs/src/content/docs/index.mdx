...
// define the task
$`Analyze FILE and extract titles to JSON using the ${schema} schema.
...
<CardGrid stagger>
    <Card title="Install the extension" icon="puzzle">
        Install the [Visual Studio Code Extension v{packageJson.version}](/genaiscript/getting-started/installation/) 
to get started.
    </Card>
...
Edit, [debug](/genaiscript/getting-started/debugging-scripts/), [run](/genaiscript/getting-started/running-scripts/) your scripts in the [Visual Studio Code](/genaiscript/getting-started/installation).
...
Seamlessly ingest and manipulate [PDFs](/genaiscript/reference/scripts/pdf), [DOCX](/genaiscript/reference/scripts/docx), CSV, and other file formats.
...
[Embeddings vector search](/genaiscript/reference/scripts/embeddings-search/) powered by [LLamaIndex](https://ts.llamaindex.ai/).
