...
<LinkCard title="agent z3" description="can formalize and solve problems using the Z3 constraint solver. If you need to run Z3, use this tool." href="/genaiscript/reference/scripts/system#systemagent_z3" />
