...
<LinkCard title="z3" description="Solves a SMTLIB2 problem using the Z3 constraint solver. Send problems one at a time." href="/genaiscript/reference/scripts/system#systemz3" />
