...
<LinkCard title="python_interpreter" description="Executes python code in a docker container. The process output is returned. Use 'print' to output data." href="/genaiscript/reference/scripts/system#systempython_interpreter" />
