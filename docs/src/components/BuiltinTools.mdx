...
<LinkCard title="python_interpreter" description="Executes python code in a docker container" href="/genaiscript/reference/scripts/system#systempython_interpreter" />
