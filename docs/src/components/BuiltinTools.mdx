...
<LinkCard title="md_find_files" description="Get the file structure of the documentation markdown/MDX files. Returns filename, title, description for each match. Use pattern to specify a regular expression to search for in the file content." href="/genaiscript/reference/scripts/system#systemmd_find_files" />
