 ...
 */
 ...
 interface GitHubProjectV2 extends GitHubNode {
  title: string;
 ...
 interface GitHubProjectV2Item extends GitHubNode {
  content?: {
    id: string;
    title: string;
    url: string;
 ...
 interface GitHubProjectV2ItemFieldValue {
  field: {
    id: string;
    name: string;
  };
 ...
 interface GitHubProjectV2CreateOptions {
  repositoryId?: string;
  ownerId?: string;
  title: string;
  shortDescription?: string;
 ...
 interface GitHubProjectV2UpdateItemOptions {
  projectId: string;
  itemId: string;
  fieldId: string;
  value: string;
