import type { DiffFile, ElementOrArray, FindFilesOptions, OptionsOrString, WorkspaceFile } from "@genaiscript/core";
import type { Edit, Range, Rule, Pos, SgNode, SgRoot, NapiConfig } from "@ast-grep/napi";
import type { PatternStyle, PatternObject, Strictness, Relation } from "@ast-grep/napi/types/rule.js";
...
export type SgLang = OptionsOrString<"html" | "js" | "javascript" | "ts" | "typescript" | "tsx" | "css" | "c" | "sql" | "angular" | "csharp" | "python" | "rust" | "elixir" | "haskell" | "go" | "dart" | "swift" | "scala">;
...
export interface Sg {
    ...
    parse(file: WorkspaceFile, options?: {
        lang?: SgLang;
    }): Promise<SgRoot>;
    search(lang: SgLang, glob: ElementOrArray<string>, matcher: string | SgMatcher, options?: SgSearchOptions): Promise<{
        /**
