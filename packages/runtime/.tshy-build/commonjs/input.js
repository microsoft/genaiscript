...
exports.shellSelect = shellSelect;
exports.shellInput = shellInput;
exports.shellConfirm = shellConfirm;
exports.confirmOrSkipInCI = confirmOrSkipInCI;
 ...
 */
async function shellSelect(message, choices, options) {
    const res = await (0, prompts_1.select)({
 ...
 */
async function shellInput(message, options) {
    const res = await (0, prompts_1.input)({
 ...
 */
async function shellConfirm(message, options) {
 ...
 */
async function confirmOrSkipInCI(message, options) {
    if (core_1.isCI)
        return true;
    const { preview } = options || {};
    if (preview) {
        (0, core_1.logVerbose)((0, core_1.indent)(`preview:`, " "));
        (0, core_1.logVerbose)((0, core_1.indent)(preview, "  "));
    }
    const res = await (0, prompts_1.confirm)({
        message,
