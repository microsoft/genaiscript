 ...
 */
export async function shellSelect(message, choices, options) {
 ...
 */
export async function shellInput(message, options) {
 ...
 */
export async function shellConfirm(message, options) {
 ...
 */
export async function confirmOrSkipInCI(message, options) {
    if (isCI)
        return true;
