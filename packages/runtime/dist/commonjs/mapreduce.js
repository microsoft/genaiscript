...
exports.reducePrompt = reducePrompt;
const core_1 = require("@genaiscript/core");
/**
 * Uses an LLM to map items to results.
 */
async function mapPrompt(items, generator, map, options) {
    const { runPrompt } = (0, core_1.resolveChatGenerationContext)(options);
    const results = [];
 ...
 */
async function reducePrompt(items, generator, reduce, defaultValue, options) {
    const { runPrompt } = (0, core_1.resolveChatGenerationContext)(options);
