import type { GitIgnorer } from "./types.js";
/**
 ...
 */
export declare function createGitIgnorer(options?: {
    extraFiles?: string[];
}): Promise<GitIgnorer>;
export declare function createIgnorer(files: string[]): Promise<GitIgnorer>;
/**
