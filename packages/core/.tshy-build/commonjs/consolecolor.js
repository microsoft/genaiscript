...
exports.setConsoleColors = setConsoleColors;
exports.wrapColor = wrapColor;
exports.wrapRgbColor = wrapRgbColor;
...
exports.consoleColors = !!stdio_js_1.stdout.isTTY;
/**
 ...
 */
function wrapRgbColor(rgb, text, background) {
    if (!exports.consoleColors)
        return text;
    const r = (rgb >> 16) & 0xff;
    const g = (rgb >> 8) & 0xff;
