...
import type { HTMLToMarkdownOptions, HTMLToTextOptions } from "./types.js";
/**
 ...
 */
export declare function HTMLToText(html: string, options?: HTMLToTextOptions & TraceOptions & CancellationOptions): Promise<string>;
/**
 ...
 */
export declare function HTMLToMarkdown(html: string, options?: HTMLToMarkdownOptions & TraceOptions & CancellationOptions): Promise<string>;
