 ...
 */
export declare function prettyTokens(n: number, direction?: "prompt" | "completion" | "both"): string;
export declare function prettyParenthesized(value: unknown): string;
/**
...
export declare function prettyValue(value: number | undefined, options?: {
    emoji?: string;
    afterEmoji?: string;
    precision?: number;
}): string;
