...
exports.unfence = unfence;
exports.unquote = unquote;
exports.filenameOrFileToContent = filenameOrFileToContent;
exports.filenameOrFileToFilename = filenameOrFileToFilename;
...
function unfence(text, language) {
    if (!text)
        return text;
    language = (0, cleaners_js_1.arrayify)(language);
    const lg = language
    ...
    if (mstart) {
        ...
        if (mend)
            return text.slice(mstart.index + mstart[0].length, mend.index);
    }
    return text;
}
/**
 ...
 */
function filenameOrFileToFilename(fileOrContent) {
...
//# sourceMappingURL=unwrappers.js.map