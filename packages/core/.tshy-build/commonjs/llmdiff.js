...
exports.DiffError = void 0;
exports.parseLLMDiffs = parseLLMDiffs;
exports.applyLLMDiff = applyLLMDiff;
exports.applyLLMPatch = applyLLMPatch;
exports.llmifyDiff = llmifyDiff;
 ...
 * @returns The LLMDiff formatted string or undefined if parsing fails.
 */
function llmifyDiff(diff) {
    if (!diff)
        return diff;
    const parsed = (0, diff_js_1.tryDiffParse)(diff);
    if (!parsed?.length)
        return undefined;
    ...
    for (const file of parsed) {
        ...
        for (const chunk of file.chunks) {
            ...
            for (const change of chunk.changes) {
                const ln = change.line !== undefined ? `[${change.line}] ` : "";
...
//# sourceMappingURL=llmdiff.js.map