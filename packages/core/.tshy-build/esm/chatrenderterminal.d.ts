import type { ChatCompletionTool, CreateChatCompletionRequest } from "./chattypes.js";
/**
 ...
 */
export declare function renderMessagesToTerminal(request: CreateChatCompletionRequest, options?: {
    preview?: boolean;
    system?: boolean;
    user?: boolean;
    assistant?: boolean;
