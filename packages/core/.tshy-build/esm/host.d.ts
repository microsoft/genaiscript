...
import type { BrowserPage, BrowseSessionOptions, ContainerHost, ContainerOptions, ContentSafety, ContentSafetyProvider, ModelOptions, Path, PythonRuntime, PythonRuntimeOptions, SerializedError, ShellOutput, ShellSelectChoice, ShellSelectOptions, ShellInputOptions, ShellConfirmOptions, ShellOptions, WorkspaceFile, WorkspaceFileSystem, WorkspaceFileWithScore, VectorSearchOptions } from "./types.js";
...
export interface RuntimeHost extends Host {
     ...
     */
    python(options?: PythonRuntimeOptions & TraceOptions & CancellationOptions): Promise<PythonRuntime>;
    /**
 ...
 */
export declare function setHost(h: Host): void;
export declare let runtimeHost: RuntimeHost;
/**
