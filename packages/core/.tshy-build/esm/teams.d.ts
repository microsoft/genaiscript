 ...
 */
export declare function microsoftTeamsChannelPostMessage(channelUrl: string, message: string, options?: {
    script?: PromptScript;
    info?: {
        runUrl?: string;
    };
...
} & TraceOptions & CancellationOptions): Promise<MicrosoftTeamsEntity>;
/**
