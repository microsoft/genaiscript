 ...
 */
export function dataUriToBuffer(filename) {
 ...
 */
export async function resolveFileBytes(filename, options) {
 ...
 */
export async function resolveFileDataUri(filename, options) {
