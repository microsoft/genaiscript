 ...
 * @version 0.0.0
 */
export type OptionsOrString<TOptions extends string> = (string & {}) | TOptions;
export type ElementOrArray<T> = T | T[];
export interface PromptGenerationConsole {
    log(...data: any[]): void;
    warn(...data: any[]): void;
    debug(...data: any[]): void;
    error(...data: any[]): void;
...
export interface PromptLike extends PromptDefinition {
    /**
...
export type SystemPromptId = OptionsOrString<string>;
export type SystemPromptInstance = {
    id: SystemPromptId;
    parameters?: Record<string, string | boolean | number | object | any>;
    vars?: Record<string, string | boolean | number | object | any>;
};
export type SystemToolId = OptionsOrString<string>;
export type FileMergeHandler = (filename: string, label: string, before: string, generated: string) => Awaitable<string>;
export interface PromptOutputProcessorResult {
    /**
     * Updated text
     */
    text?: string;
...
export type PromptOutputProcessorHandler = (output: GenerationOutput) => PromptOutputProcessorResult | Promise<PromptOutputProcessorResult> | undefined | Promise<undefined> | void | Promise<void>;
export type PromptTemplateResponseType = "text" | "json" | "yaml" | "markdown" | "json_object" | "json_schema" | undefined;
export type ModelType = OptionsOrString<"large" | "small" | "tiny" | "long" | "vision" | "vision_small" | "reasoning" | "reasoning_small" | "openai:gpt-4.1" | "openai:gpt-4.1-mini" | "openai:gpt-4.1-nano" | "openai:gpt-4o" | "openai:gpt-4o-mini" | "openai:gpt-3.5-turbo" | "openai:o3-mini" | "openai:o3-mini:low" | "openai:o3-mini:medium" | "openai:o3-mini:high" | "openai:o1" | "openai:o1-mini" | "openai:o1-preview" | "github:openai/gpt-4.1" | "github:openai/gpt-4o" | "github:openai/gpt-4o-mini" | "github:openai/o1" | "github:openai/o1-mini" | "github:openai/o3-mini" | "github:openai/o3-mini:low" | "github:microsoft/mai-ds-r1" | "github:deepseek/deepseek-v3" | "github:deepseek/deepseek-r1" | "github:microsoft/phi-4" | "github_copilot_chat:current" | "github_copilot_chat:gpt-3.5-turbo" | "github_copilot_chat:gpt-4o-mini" | "github_copilot_chat:gpt-4o-2024-11-20" | "github_copilot_chat:gpt-4" | "github_copilot_chat:o1" | "github_copilot_chat:o1:low" | "github_copilot_chat:o1:medium" | "github_copilot_chat:o1:high" | "github_copilot_chat:o3-mini" | "github_copilot_chat:o3-mini:low" | "github_copilot_chat:o3-mini:medium" | "github_copilot_chat:o3-mini:high" | "azure:gpt-4o" | "azure:gpt-4o-mini" | "azure:o1" | "azure:o1-mini" | "azure:o1-preview" | "azure:o3-mini" | "azure:o3-mini:low" | "azure:o3-mini:medium" | "azure:o3-mini:high" | "azure_ai_inference:gpt-4.1" | "azure_ai_inference:gpt-4o" | "azure_ai_inference:gpt-4o-mini" | "azure_ai_inference:o1" | "azure_ai_inference:o1-mini" | "azure_ai_inference:o1-preview" | "azure_ai_inference:o3-mini" | "azure_ai_inference:o3-mini:low" | "azure_ai_inference:o3-mini:medium" | "azure_ai_inference:o3-mini:high" | "azure_ai_inference:deepSeek-v3" | "azure_ai_inference:deepseek-r1" | "ollama:gemma3:4b" | "ollama:llama3.2" | "ollama:command-r7b:7b" | "anthropic:claude-3-7-sonnet-latest" | "anthropic:claude-3-7-sonnet-latest:low" | "anthropic:claude-3-7-sonnet-latest:medium" | "anthropic:claude-3-7-sonnet-latest:high" | "anthropic_bedrock:anthropic.claude-3-7-sonnet-20250219-v1:0" | "anthropic_bedrock:anthropic.claude-3-7-sonnet-20250219-v1:0:low" | "anthropic_bedrock:anthropic.claude-3-7-sonnet-20250219-v1:0:medium" | "anthropic_bedrock:anthropic.claude-3-7-sonnet-20250219-v1:0:high" | "huggingface:microsoft/Phi-3-mini-4k-instruct" | "jan:llama3.2-3b-instruct" | "google:gemini-2.0-flash-exp" | "llamafile" | "sglang" | "vllm" | "echo" | "none">;
export type EmbeddingsModelType = OptionsOrString<"openai:text-embedding-3-small" | "openai:text-embedding-3-large" | "openai:text-embedding-ada-002" | "github:text-embedding-3-small" | "github:text-embedding-3-large" | "azure:text-embedding-3-small" | "azure:text-embedding-3-large" | "azure_ai_inference:text-embedding-3-small" | "azure_ai_inference:text-embedding-3-large" | "ollama:nomic-embed-text" | "google:text-embedding-004" | "huggingface:nomic-ai/nomic-embed-text-v1.5">;
export type ModelSmallType = OptionsOrString<"openai:gpt-4o-mini" | "github:openai/gpt-4o-mini" | "azure:gpt-4o-mini" | "github:microsoft/phi-4">;
export type ModelVisionType = OptionsOrString<"openai:gpt-4o" | "github:openai/gpt-4o" | "azure:gpt-4o" | "azure:gpt-4o-mini">;
export type ModelImageGenerationType = OptionsOrString<"openai:gpt-image-1" | "openai:dall-e-2" | "openai:dall-e-3">;
export type ModelProviderType = OptionsOrString<"openai" | "azure" | "azure_serverless" | "azure_serverless_models" | "anthropic" | "anthropic_bedrock" | "google" | "huggingface" | "mistral" | "alibaba" | "github" | "transformers" | "ollama" | "lmstudio" | "jan" | "sglang" | "vllm" | "llamafile" | "litellm" | "github_copilot_chat" | "deepseek" | "whisperasr" | "echo">;
...
export interface ModelAliasesOptions extends ModelConnectionOptions {
    /**
...
export type ReasoningEffortType = "high" | "medium" | "low";
...
export interface PromptSystemOptions extends PromptSystemSafetyOptions {
    /**
...
export interface ScriptRuntimeOptions extends LineNumberingOptions {
    /**
     * Secrets required by the prompt
     */
    secrets?: string[];
}
export type PromptJSONParameterType<T> = T & {
    required?: boolean;
};
export type PromptParameterType = string | number | boolean | object | PromptJSONParameterType<JSONSchemaNumber> | PromptJSONParameterType<JSONSchemaString> | PromptJSONParameterType<JSONSchemaBoolean>;
export type PromptParametersSchema = Record<string, PromptParameterType | [PromptParameterType]>;
export type PromptParameters = Record<string, string | number | boolean | object>;
export type PromptAssertion = {
    ...
    type: "icontains" | "not-icontains" | "equals" | "not-equals" | "starts-with" | "not-starts-with";
    value: string;
} | {
 ...
 */
export interface PromptRedteam {
    /**
 ...
 */
export type FenceFormat = "markdown" | "xml" | "none";
export interface FenceFormatOptions {
    /**
     * Formatting of code sections
     */
    fenceFormat?: FenceFormat;
}
export interface ModelTemplateOptions extends FenceFormatOptions {
    /**
...
export interface PromptScript extends PromptLike, PromptBranding, ModelOptions, ModelAliasesOptions, PromptSystemOptions, EmbeddingsModelOptions, ContentSafetyOptions, SecretDetectionOptions, GitIgnoreFilterOptions, ScriptRuntimeOptions, McpToolAnnotations, MetadataOptions, TerminalOptions {
    /**
...
export interface WorkspaceFileWithScore extends WorkspaceFile {
    /**
 ...
 */
export interface OutputTrace extends ToolCallTrace {
    /**
 ...
 */
export type CharPosition = [number, number];
/**
 * Describes a run of text.
 */
export type CharRange = [CharPosition, CharPosition];
/**
...
export interface ReplaceEdit extends FileEdit {
    type: "replace";
    range: CharRange | LineRange;
    text: string;
}
export interface InsertEdit extends FileEdit {
    type: "insert";
    pos: CharPosition | number;
    text: string;
}
export interface DeleteEdit extends FileEdit {
    type: "delete";
    range: CharRange | LineRange;
}
export interface CreateFileEdit extends FileEdit {
    type: "createfile";
    overwrite?: boolean;
...
export type ToolCallOutput = string | number | boolean | ToolCallContent | ShellOutput | WorkspaceFile | RunPromptResult | SerializedError | undefined;
export interface WorkspaceFileCache<K, V> {
    /**
     * Name of the cache
     */
    name: string;
...
export interface WorkspaceGrepOptions extends FilterGitFilesOptions {
    /**
     * List of paths to
     */
...
export interface INIParseOptions extends JSONSchemaValidationOptions {
    defaultValue?: any;
}
export interface FilterGitFilesOptions {
    /**
     * Ignore workspace .gitignore instructions
     */
    applyGitIgnore?: false | undefined;
}
export interface FindFilesOptions extends FilterGitFilesOptions {
...
export interface WorkspaceFileSystem {
    ...
    grep(pattern: string | RegExp, glob: string, options?: Omit<WorkspaceGrepOptions, "path" | "glob">): Promise<WorkspaceGrepResult>;
    /**
     ...
     * @param path
     */
    readJSON(path: string | Awaitable<WorkspaceFile>, options?: JSONSchemaValidationOptions): Promise<any>;
    /**
     * Reads the content of a file and parses to YAML.
     * @param path
     */
    readYAML(path: string | Awaitable<WorkspaceFile>, options?: JSONSchemaValidationOptions): Promise<any>;
    /**
     ...
     * @param path
     */
    readCSV<T extends object>(path: string | Awaitable<WorkspaceFile>, options?: CSVParseOptions): Promise<T[]>;
    /**
     ...
     * @param options
     */
    readData(path: string | Awaitable<WorkspaceFile>, options?: CSVParseOptions & INIParseOptions & XMLParseOptions & JSONSchemaValidationOptions): Promise<any>;
    /**
     ...
     * @param bytes
     */
    writeCached(bytes: BufferLike, options?: {
        scope?: "workspace" | "run";
        /**
         * Filename extension
         */
...
export interface ToolCallback {
    ...
    } & Record<string, any>) => Awaitable<ToolCallOutput>;
}
...
export type ChatContentPart = ChatContentPartText | ChatContentPartImage | ChatContentPartInputAudio | ChatContentPartFile;
...
export type ChatMessage = ChatSystemMessage | ChatUserMessage | ChatAssistantMessage | ChatToolMessage | ChatFunctionMessage;
 ...
 * reasoning sections.
 */
assistantText: string) => Awaitable<{
    messages?: ChatMessage[];
} | undefined | void>;
 ...
 */
export interface ExpansionVariables extends Required<Pick<ChatGenerationContextOptions, "generator">> {
    /**
...
export type PromptSystemArgs = Omit<PromptArgs, "model" | "embeddingsModel" | "temperature" | "topP" | "maxTokens" | "seed" | "tests" | "responseLanguage" | "responseType" | "responseSchema" | "files" | "modelConcurrency" | "redteam" | "metadata">;
export type StringLike = string | WorkspaceFile | WorkspaceFile[];
...
export interface FenceOptions extends LineNumberingOptions, FenceFormatOptions {
     ...
     */
    language?: "markdown" | "json" | "yaml" | "javascript" | "typescript" | "python" | "shell" | "toml" | string;
    /**
     * JSON schema identifier
     */
    schema?: string;
}
export type PromptCacheControlType = "ephemeral";
...
export interface FileFilterOptions extends GitIgnoreFilterOptions {
    /**
...
export interface PromptSystemSafetyOptions {
    /**
...
export interface DefOptions extends FenceOptions, ContextExpansionOptions, DataFilter, RangeOptions, FileFilterOptions, ContentSafetyOptions {
    /**
 ...
 */
export interface DefDiffOptions extends ContextExpansionOptions, FenceFormatOptions, LineNumberingOptions {
}
...
export interface DefImagesOptions extends ImageTransformOptions {
    /**
...
export type JSONSchemaSimpleType = JSONSchemaString | JSONSchemaNumber | JSONSchemaBoolean | JSONSchemaObject | JSONSchemaArray;
export type JSONSchemaType = JSONSchemaSimpleType | JSONSchemaAnyOf | null;
export interface JSONSchemaAnyOf {
    anyOf: JSONSchemaType[];
    uiGroup?: string;
}
export interface JSONSchemaDescribed {
    /**
...
export interface JSONSchemaString extends JSONSchemaDescribed {
    type: "string";
    uiType?: "textarea";
...
export interface JSONSchemaNumber extends JSONSchemaDescribed {
    type: "number" | "integer";
    default?: number;
    minimum?: number;
...
export interface JSONSchemaBoolean extends JSONSchemaDescribed {
    type: "boolean";
    uiType?: "runOption";
    default?: boolean;
}
export interface JSONSchemaObject extends JSONSchemaDescribed {
    $schema?: string;
    type: "object";
    properties?: {
...
export interface JSONSchemaArray extends JSONSchemaDescribed {
    $schema?: string;
    type: "array";
...
export interface FileEditValidation {
    /**
     * JSON schema
     */
    schema?: JSONSchema;
...
export interface RunPromptUsage {
    /**
...
export interface XMLParseOptions extends JSONSchemaValidationOptions {
...
export type TokenDecoder = (lines: Iterable<number>) => string;
...
export interface CSVParseOptions extends JSONSchemaValidationOptions {
    delimiter?: string;
    headers?: string[];
    repair?: boolean;
}
export interface TextChunk extends WorkspaceFile {
    lineStart: number;
    lineEnd: number;
}
export interface TextChunkerConfig extends LineNumberingOptions {
    model?: ModelType;
    chunkSize?: number;
    chunkOverlap?: number;
    docType?: OptionsOrString<"cpp" | "python" | "py" | "java" | "go" | "c#" | "c" | "cs" | "ts" | "js" | "tsx" | "typescript" | "js" | "jsx" | "javascript" | "php" | "md" | "mdx" | "markdown" | "rst" | "rust">;
}
...
export interface PDFPageImage extends WorkspaceFile {
    id: string;
    width: number;
    height: number;
}
...
export interface DocxParseOptions extends CacheOptions {
    /**
     * Desired output format
     */
    format?: "markdown" | "text" | "html";
}
export interface EncodeIDsOptions {
    matcher?: RegExp;
    prefix?: string;
    open?: string;
    close?: string;
...
export interface Parsers {
     ...
     */
    JSON5(content: string | WorkspaceFile, options?: {
        defaultValue?: any;
    } & JSONSchemaValidationOptions): any | undefined;
    /**
     ...
     */
    YAML(content: string | WorkspaceFile, options?: {
        defaultValue?: any;
    } & JSONSchemaValidationOptions): any | undefined;
    /**
     ...
     */
    TOML(content: string | WorkspaceFile, options?: {
        defaultValue?: any;
    } & JSONSchemaValidationOptions): any | undefined;
    /**
     ...
     * @param defaultValue
     */
    frontmatter(content: string | WorkspaceFile, options?: {
        defaultValue?: any;
     ...
     * @param content
     */
    PDF(content: string | WorkspaceFile, options?: ParsePDFOptions): Promise<{
        /**
     ...
     * @param content
     */
    DOCX(content: string | WorkspaceFile, options?: DocxParseOptions): Promise<{
        file?: WorkspaceFile;
        error?: string;
    }>;
    /**
     ...
     * @param content
     */
    XML(content: string | WorkspaceFile, options?: {
        defaultValue?: any;
    } & XMLParseOptions): any | undefined;
    /**
     ...
     */
    diff(left: string | WorkspaceFile, right: string | WorkspaceFile, options?: DefDiffOptions): string;
    /**
     ...
     * @param options
     */
    encodeIDs(text: string, options?: EncodeIDsOptions): {
        encoded: string;
        text: string;
...
export interface PromptyFrontmatter {
    ...
    inputs?: Record<string, JSONSchemaArray | JSONSchemaNumber | JSONSchemaBoolean | JSONSchemaString | JSONSchemaObject | {
        type: "list";
    }>;
...
export interface DiffNormalChange {
    type: "normal";
    ln1: number;
    ln2: number;
    normal: true;
...
export interface DiffDeleteChange {
    type: "del";
    del: true;
    ln: number;
    content: string;
...
export interface DIFFObject {
     ...
     * @param diff
     */
    findChunk(file: string, range: number | [number, number] | number[], diff: ElementOrArray<DiffFile>): {
        file?: DiffFile;
        chunk?: DiffChunk;
    } | undefined;
    /**
     ...
     * @param options
     */
    createPatch(left: string | WorkspaceFile, right: string | WorkspaceFile, options?: {
        context?: number;
        ignoreCase?: boolean;
...
export interface FFmpegCommandOptions extends CacheOptions {
...
export interface VideoExtractFramesOptions extends FFmpegCommandOptions {
    /**
...
export interface VideoExtractClipOptions extends FFmpegCommandOptions {
    /**
...
export interface VideoExtractAudioOptions extends FFmpegCommandOptions {
    /**
...
export interface Ffmpeg {
     ...
     * @param options
     */
    extractFrames(file: string | WorkspaceFile, options?: VideoExtractFramesOptions): Promise<string[]>;
    /**
    ...
    run(input: string | WorkspaceFile, builder: (cmd: FfmpegCommandBuilder, options?: {
        input: string;
        dir: string;
    }) => Awaitable<string>, options?: FFmpegCommandOptions): Promise<string[]>;
}
...
export type GitHubWorkflowRunStatus = "completed" | "action_required" | "cancelled" | "failure" | "neutral" | "skipped" | "stale" | "success" | "timed_out" | "in_progress" | "queued" | "requested" | "waiting" | "pending";
...
export type GitHubReactionType = "eyes" | "hooray" | "heart" | "rocket" | "confused" | "laugh" | "+1" | "-1";
...
export interface GitHubFile extends WorkspaceFile {
...
export interface GitHubIssueUpdateOptions {
    title?: string;
    body?: string;
    assignee?: string;
    state?: "open" | "closed";
...
export interface GitHub {
     ...
     * @param options
     */
    listWorkflowRuns(workflow_id: string | number, options?: {
        branch?: string;
        event?: string;
        status?: GitHubWorkflowRunStatus;
    } & GitHubPaginationOptions): Promise<GitHubWorkflowRun[]>;
    /**
     ...
     * @param runId
     */
    listWorkflowRunArtifacts(runId: number | string, options?: GitHubPaginationOptions): Promise<GitHubArtifact[]>;
    /**
     ...
     * @param jobId
     */
    downloadWorkflowJobLog(jobId: number, options?: {
        llmify?: boolean;
    }): Promise<string>;
    /**
    ...
    listIssues(options?: {
        ...
        since?: string;
        mentioned?: string;
    } & GitHubPaginationOptions): Promise<GitHubIssue[]>;
    /**
     ...
     */
    assignIssueToBot(issue_number: number | string, options?: {
        bot?: string;
    }): Promise<{
        id: string;
        title: string;
     ...
     */
    createIssue(title: string, body: string, options?: GitHubIssueCreateOptions): Promise<GitHubIssue>;
    /**
     * Updates an issue or pull request on GitHub
     * @param issueNumber
     * @param options
     */
    updateIssue(issueNumber: number | string, options: GitHubIssueUpdateOptions): Promise<GitHubIssue>;
    /**
     ...
     * @param options
     */
    listIssueComments(issue_number: number | string, options?: GitHubPaginationOptions): Promise<GitHubComment[]>;
    /**
     * Updates a comment on a GitHub issue
     * @param comment_id
     * @param body the updated comment body
     */
    updateIssueComment(comment_id: number | string, body: string, options?: GitHubAIDisclaimerOptions): Promise<GitHubComment>;
    createReaction(type: "issue" | "issueComment" | "pullRequestReviewComment", id: number | string, reaction: GitHubReactionType): Promise<GitHubReaction>;
    /**
    ...
    listPullRequests(options?: {
        ...
        direction?: "asc" | "desc";
    } & GitHubPaginationOptions): Promise<GitHubPullRequest[]>;
    /**
     ...
     * @param options
     */
    listPullRequestReviewComments(pull_number: number, options?: GitHubPaginationOptions): Promise<GitHubComment[]>;
    /**
     ...
     */
    ref: string): Promise<WorkspaceFile>;
    /**
     ...
     * Lists tags in a GitHub repository
     */
    getRepositoryContent(path?: string, options?: {
        ref?: string;
        glob?: string;
     ...
     * @param options
     */
    uploadAsset(file: BufferLike, options?: {
        branchName?: string;
    }): Promise<string>;
    /**
...
export interface MDObject {
     ...
     * @param options
     */
    chunk(text: string | WorkspaceFile, options?: {
        maxTokens?: number;
        model?: string;
     ...
     * @param value
     */
    stringify(value: unknown, options?: {
        quoteValues?: boolean;
        headings?: number;
        headingLevel?: number;
    }): string;
...
export interface CSVObject {
     ...
     */
    markdownify(csv: object[], options?: {
        headers?: string[];
    }): string;
    /**
...
export interface ContentSafety {
     ...
     */
    detectPromptInjection?(content: Awaitable<ElementOrArray<string> | ElementOrArray<WorkspaceFile>>): Promise<{
     ...
     * @param content
     */
    detectHarmfulContent?(content: Awaitable<ElementOrArray<string> | ElementOrArray<WorkspaceFile>>): Promise<{
...
export interface VectorIndexOptions extends EmbeddingsModelOptions {
    /**
...
export interface VectorSearchOptions extends VectorIndexOptions {
    /**
...
export interface Retrieval {
     ...
     */
    vectorSearch(query: string, files: (string | WorkspaceFile) | (string | WorkspaceFile)[], options?: VectorSearchOptions): Promise<WorkspaceFile[]>;
    /**
     ...
     */
    fuzzSearch(query: string, files: WorkspaceFile | WorkspaceFile[], options?: FuzzSearchOptions): Promise<WorkspaceFile[]>;
}
...
export interface DataFilter extends ArrayFilter {
    /**
...
export interface DefDataOptions extends Omit<ContextExpansionOptions, "maxTokens">, FenceFormatOptions, DataFilter, ContentSafetyOptions {
    /**
...
export interface DefSchemaOptions {
    /**
     * Output format in the prompt.
     */
    format?: "typescript" | "json" | "yaml";
}
export type ChatFunctionArgs = {
    context: ToolCallContext;
} & Record<string, any>;
export type ChatFunctionHandler = (args: ChatFunctionArgs) => Awaitable<ToolCallOutput>;
export type ChatMessageRole = "user" | "assistant" | "system";
export interface HistoryMessageUser {
    role: "user";
    content: string;
}
export interface HistoryMessageAssistant {
    role: "assistant";
    name?: string;
    content: string;
}
export interface WriteTextOptions extends ContextExpansionOptions {
    /**
...
export type PromptGenerator = (ctx: ChatGenerationContext) => Awaitable<unknown>;
export interface PromptGeneratorOptions extends ModelOptions, PromptSystemOptions, ContentSafetyOptions, SecretDetectionOptions, MetadataOptions {
    /**
     * Label for trace
     */
    label?: string;
...
export interface PromptTemplateString {
    /**
...
export type ImportTemplateArgumentType = Awaitable<string | number | boolean> | (() => Awaitable<string | number | boolean>);
/**
 ...
 */
export interface ChatTurnGenerationContext {
    importTemplate(files: ElementOrArray<string | WorkspaceFile>, templateArguments?: Record<string, ImportTemplateArgumentType>, options?: ImportTemplateOptions): void;
    ...
    def(name: string, body: string | WorkspaceFile | WorkspaceFile[] | ShellOutput | Fenced | RunPromptResult, options?: DefOptions): string;
...
export interface RunPromptResultPromiseWithOptions extends Promise<RunPromptResult> {
    options(values?: PromptGeneratorOptions): RunPromptResultPromiseWithOptions;
}
export interface DefToolOptions extends ContentSafetyOptions {
    /**
     ...
     */
    intent?: OptionsOrString<"description"> | ((options: {
        tool: ToolDefinition;
        args: any;
        result: string;
        generator: ChatGenerationContext;
...
export interface DefAgentOptions extends Omit<PromptGeneratorOptions, "label">, DefToolOptions {
    /**
...
export interface McpServerConfig extends ContentSafetyOptions {
    /**
...
export type BufferLike = string | WorkspaceFile | Buffer | Blob | ArrayBuffer | Uint8Array | ReadableStream | SharedArrayBuffer;
export type TranscriptionModelType = OptionsOrString<"openai:whisper-1" | "openai:gpt-4o-transcribe" | "whisperasr:default">;
export interface ImageGenerationOptions extends ImageTransformOptions, RetryOptions {
     ...
     */
    size?: OptionsOrString<"auto" | "landscape" | "portrait" | "square" | "1536x1024" | "1024x1536" | "256x256" | "512x512" | "1024x1024" | "1024x1792" | "1792x1024">;
    /**
...
export type SpeechModelType = OptionsOrString<"openai:tts-1-hd" | "openai:tts-1" | "openai:gpt-4o-mini-tts">;
export type SpeechVoiceType = OptionsOrString<"alloy" | "ash" | "coral" | "echo" | "fable" | "onyx" | "nova" | "sage" | "shimmer" | "verse" | "ballad">;
export interface SpeechOptions extends CacheOptions, RetryOptions {
    /**
...
export interface ChatGenerationContext extends ChatTurnGenerationContext {
    ...
    defTool(tool: Omit<ToolCallback, "generator"> | McpServersConfig | McpClient, options?: DefToolOptions): void;
    defTool(name: string, description: string, parameters: PromptParametersSchema | JSONSchema, fn: ChatFunctionHandler, options?: DefToolOptions): void;
    defAgent(name: string, description: string, fn: string | ChatAgentHandler, options?: DefAgentOptions): void;
    defChatParticipant(participant: ChatParticipantHandler, options?: ChatParticipantOptions): void;
    defFileOutput(pattern: ElementOrArray<string | WorkspaceFile>, description: string, options?: FileOutputOptions): void;
    runPrompt(generator: string | PromptGenerator, options?: PromptGeneratorOptions): Promise<RunPromptResult>;
    ...
    transcribe(audio: string | WorkspaceFile, options?: TranscriptionOptions): Promise<TranscriptionResult>;
    ...
    generateImage(prompt: string, images: ElementOrArray<BufferLike>, options?: ImageGenerationOptions): Promise<{
        image: WorkspaceFile;
        revisedPrompt?: string;
    }>;
}
...
export interface BrowserLocatorSelector {
    ...
    getByRole(role: "alert" | "alertdialog" | "application" | "article" | "banner" | "blockquote" | "button" | "caption" | "cell" | "checkbox" | "code" | "columnheader" | "combobox" | "complementary" | "contentinfo" | "definition" | "deletion" | "dialog" | "directory" | "document" | "emphasis" | "feed" | "figure" | "form" | "generic" | "grid" | "gridcell" | "group" | "heading" | "img" | "insertion" | "link" | "list" | "listbox" | "listitem" | "log" | "main" | "marquee" | "math" | "meter" | "menu" | "menubar" | "menuitem" | "menuitemcheckbox" | "menuitemradio" | "navigation" | "none" | "note" | "option" | "paragraph" | "presentation" | "progressbar" | "radio" | "radiogroup" | "region" | "row" | "rowgroup" | "rowheader" | "scrollbar" | "search" | "searchbox" | "separator" | "slider" | "spinbutton" | "status" | "strong" | "subscript" | "superscript" | "switch" | "tab" | "table" | "tablist" | "tabpanel" | "term" | "textbox" | "time" | "timer" | "toolbar" | "tooltip" | "tree" | "treegrid" | "treeitem", options?: {
        ...
        name?: string;
        selected?: boolean;
    } & TimeoutOptions): BrowserLocator;
    /**
     * Allows locating input elements by the text of the associated <label> or aria-labelledby element, or by the aria-label attribute.
     * @param name
     * @param options
     */
    getByLabel(name: string, options?: {
        exact?: boolean;
    } & TimeoutOptions): BrowserLocator;
    /**
 ...
 */
export interface BrowserPage extends BrowserLocatorSelector {
    /**
     ...
     * @param options
     */
    goto(url: string, options?: BrowseGotoOptions): Promise<null | BrowseResponse>;
    /**
     ...
     */
    evaluateHandle<T = any>(selector: string, arg?: any): Promise<BrowserJSHandle>;
    /**
...
export interface ShellSelectChoice {
    name?: string;
    value: string;
    description?: string;
}
...
export interface McpServerToolResultTextPart {
    type: "text";
    text: string;
}
export interface McpServerToolResultImagePart {
    type: "image";
    data: string;
    mimeType: string;
}
export interface McpServerToolResourcePart {
    type: "resource";
    text?: string;
    uri?: string;
    mimeType?: string;
...
export type McpServerToolResultPart = McpServerToolResultTextPart | McpServerToolResultImagePart | McpServerToolResourcePart;
...
export interface ResourceHost {
     ...
     * @param content
     */
    publishResource(name: string, content: BufferLike, options?: Partial<Pick<ResourceReference, "description" | "mimeType">> & SecretDetectionOptions): Promise<string>;
    /**
...
export interface PromiseQueue {
     ...
     * @param fn
     */
    add<Arguments extends unknown[], ReturnType>(function_: (...arguments_: Arguments) => Awaitable<ReturnType>, ...arguments_: Arguments): Promise<ReturnType>;
    /**
...
export interface LanguageModelHost {
    /**
     ...
     */
    resolveLanguageModelProvider(provider: ModelProviderType, options?: {
        listModels?: boolean;
        token?: boolean;
    }): Promise<LanguageModelProviderInfo>;
}
export type ContentSafetyProvider = "azure";
export interface ContentSafetyHost {
    /**
...
export type FetchOptions = RequestInit & RetryOptions;
export type FetchTextOptions = Omit<FetchOptions, "body" | "signal" | "window"> & {
...
export interface PromptHost extends ShellHost, LoggerHost, McpHost, ResourceHost, UserInterfaceHost, LanguageModelHost, ContentSafetyHost {
    /**
     ...
     * @param options
     */
    fetchText(url: string | WorkspaceFile, options?: FetchTextOptions): Promise<{
        ok: boolean;
        status: number;
        text?: string;
        file?: WorkspaceFile;
...
export interface WorkspaceFileWithDescription extends WorkspaceFile {
    /**
 ...
 */
export interface MessageChannelClient {
    /**
...
export interface ContainerHost extends ShellHost {
    /**
     ...
     */
    copyTo(fromHost: string | string[], toContainer: string, options?: Omit<FindFilesOptions, "readText">): Promise<string[]>;
    /**
...
export interface PromptContext extends ChatGenerationContext {
...
export type RuntimePromptContext = Pick<PromptContext, "host" | "env" | "workspace" | "retrieval" | "prompt" | "runPrompt" | "generateImage" | "transcribe" | "speak">;
