 ...
 */
export function isJSONObjectOrArray(text) {
 ...
 */
export function JSONTryParse(text) {
    try {
 ...
 */
export function JSON5parse(text, options) {
    try {
 ...
 */
export function JSON5TryParse(text, defaultValue) {
    if (text === undefined)
        return undefined;
    if (text === null)
        return null;
 ...
 */
export function JSONLLMTryParse(s) {
