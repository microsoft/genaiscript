 ...
 */
export declare function frontmatterTryParse(text: string | WorkspaceFile, options?: {
 ...
 */
export declare function updateFrontmatter(text: string, newFrontmatter: any, options?: {
    format: "yaml" | "json";
}): string;
