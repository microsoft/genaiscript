 ...
 */
export declare function githubParseEnv(env: Record<string, string>, options?: {
    issue?: number;
    resolveToken?: boolean;
    resolveIssue?: boolean;
    resolveCommit?: boolean;
} & Partial<Pick<GithubConnectionInfo, "owner" | "repo">> & TraceOptions & CancellationOptions): Promise<GithubConnectionInfo>;
/**
 ...
 */
export declare function githubUpdatePullRequestDescription(script: PromptScript, info: GithubConnectionInfo, text: string, commentTag: string, options?: CancellationOptions): Promise<{
    updated: boolean;
    statusText: string;
}>;
/**
 ...
 */
export declare function generatedByFooter(script: PromptScript, info: {
    runUrl?: string;
}, code?: string, stats?: GenerationStats): string;
/**
 ...
 */
export declare function appendGeneratedComment(script: PromptScript, info: {
    runUrl?: string;
    owner: string;
    repo: string;
}, annotation: Diagnostic): string;
export declare function githubCreateIssueComment(script: PromptScript, info: GithubConnectionInfo, body: string, commentTag: string, options?: CancellationOptions & {
 ...
 */
export declare function githubCreatePullRequestReviews(script: PromptScript, info: GithubConnectionInfo, annotations: Diagnostic[], options?: CancellationOptions): Promise<boolean>;
export declare class GitHubClient implements GitHub {
    ...
    getOrCreateRef(branchName: string, options?: {
        base?: string;
    ...
    } & GitHubPaginationOptions): Promise<GitHubGist[]>;
    getGist(gist_id?: string): Promise<GitHubGist | undefined>;
    getIssue(issue_number?: number | string): Promise<GitHubIssue>;
    createReaction(type: "issue" | "issueComment" | "pullRequestReviewComment", id: number | string, reaction: GitHubReactionType): Promise<GitHubReaction | undefined>;
    ...
    updateIssueComment(comment_id: number | string, body: string): Promise<{
        id: number;
        node_id: string;
        url: string;
        body?: string;
    ...
    listIssueComments(issue_number: number, options?: {
        reactions?: boolean;
    } & GitHubPaginationOptions): Promise<GitHubComment[]>;
    ...
    listWorkflowRuns(workflowIdOrFilename: string | number, options?: {
        branch?: string;
    ...
    listWorkflowJobs(run_id: number, options?: {
        filter?: "all" | "latest";
    } & GitHubPaginationOptions): Promise<GitHubWorkflowJob[]>;
    /**
     * Downloads a GitHub Action workflow run log
     * @param jobId
     */
    downloadWorkflowJobLog(job_id: number, options?: {
        llmify?: boolean;
    }): Promise<string>;
    private downloadJob;
