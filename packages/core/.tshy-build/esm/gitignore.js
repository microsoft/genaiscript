 ...
 */
export async function createGitIgnorer(options) {
...
export async function createIgnorer(files) {
    ...
    return (files) => files ? ig.filter(files?.map(filenameOrFileToFilename)) : [];
}
/**
 ...
 */
export async function filterGitIgnore(files) {
 ...
 */
export async function gitIgnoreEnsure(dir, entries) {
