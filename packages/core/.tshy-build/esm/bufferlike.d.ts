 ...
 */
export declare function resolveBufferLike(bufferLike: BufferLike, options?: TraceOptions): Promise<Buffer>;
export declare function resolveBufferLikeAndExt(bufferLike: BufferLike, options?: TraceOptions): Promise<{
    bytes: Buffer;
    ext: string;
}>;
/**
