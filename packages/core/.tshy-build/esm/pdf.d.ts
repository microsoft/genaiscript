...
import type { ParsePDFOptions, PDFPage } from "./types.js";
/**
 ...
 */
export declare function parsePdf(filenameOrBuffer: string | Uint8Array, options?: ParsePDFOptions & TraceOptions & CancellationOptions): Promise<{
    pages: PDFPage[];
    content: string;
