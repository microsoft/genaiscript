export default {
    ...
    providers: [
        ...
        },
        {
            ...
            env: {
                AZURE_OPENAI_API_ENDPOINT: {
                    description: "Azure OpenAI endpoint. In the Azure Portal, open your Azure OpenAI resource, Keys and Endpoints, copy Endpoint.",
                    required: true,
                    format: "url",
                },
        ...
        },
        {
            ...
            logprobs: false,
            topLogprobs: false,
            limitations: "Smaller context windows, and rate limiting in free tier. See https://docs.github.com/en/github-models/use-github-models/prototyping-with-ai-models.",
            prediction: false,
            listModels: false,
            bearerToken: true,
            aliases: {
            ...
            env: {
                GITHUB_TOKEN: {
                    description: "GitHub token with `models: read` permission at least (https://microsoft.github.io/genaiscript/reference/github-actions/#github-models-permissions).",
                    required: true,
                    secret: true,
                },
            },
...
//# sourceMappingURL=llmsdata.js.map