 ...
 */
export async function azureDevOpsParseEnv(env) {
 ...
 */
export async function azureDevOpsUpdatePullRequestDescription(script, info, text, commentTag) {
    ...
    if (res.status !== 200)
        ...
        logVerbose(`pull request updated`);
}
/**
 ...
 */
export async function azureDevOpsCreateIssueComment(script, info, body, commentTag) {
