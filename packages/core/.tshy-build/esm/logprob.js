 ...
 */
export function serializeLogProb(content) {
 ...
 */
export function serializeChunkChoiceToLogProbs(choice) {
 ...
 */
export function renderLogprob(logprob) {
 ...
 */
export function logprobColor(logprob, options) {
 ...
 */
export function logprobToMarkdown(value, options) {
 ...
 */
export function topLogprobsToMarkdown(value, options) {
 ...
 */
export function computePerplexity(logprobs) {
    if (!logprobs?.length)
        return undefined;
 ...
 */
export function computeStructuralUncertainty(logprobs) {
    if (!logprobs?.length)
        return undefined;
    const vs = logprobs
