...
import { MODEL_PROVIDER_ANTHROPIC, MODEL_PROVIDER_ANTHROPIC_BEDROCK, MODEL_PROVIDER_GITHUB_COPILOT_CHAT, MODEL_PROVIDER_GITHUB, MODEL_PROVIDER_LMSTUDIO, MODEL_PROVIDER_OLLAMA, MODEL_PROVIDER_WHISPERASR, MODEL_PROVIDER_AZURE_OPENAI, MODEL_PROVIDER_ECHO, MODEL_PROVIDER_NONE, MODEL_PROVIDER_AZURE_AI_INFERENCE, MODEL_PROVIDER_MCP, } from "./constants.js";
 ...
 */
export function resolveLanguageModel(provider) {
    ...
    if (provider === MODEL_PROVIDER_ECHO)
        return EchoModel;
    if (provider === MODEL_PROVIDER_NONE)
        return NoneModel;
