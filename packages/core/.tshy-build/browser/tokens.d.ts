 ...
 */
export declare function approximateTokens(text: string, options?: {
    overcount?: number;
 ...
 * /NO P/
 */
export declare function truncateTextToTokens(content: string, maxTokens: number, encoder: TokenEncoder, options?: {
    tokens?: number;
    last?: boolean;
    threshold?: number;
}): string;
