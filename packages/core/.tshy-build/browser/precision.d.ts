 ...
 */
export declare function roundWithPrecision(x: number | undefined, digits: number, round?: (x: number) => number): number;
/**
 ...
 */
export declare function renderWithPrecision(x: number | undefined, digits: number, round?: (x: number) => number): string;
