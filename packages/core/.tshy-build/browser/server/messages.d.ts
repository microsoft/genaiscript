import type { ChatCompletionAssistantMessageParam, ChatCompletionMessageParam } from "../chattypes.js";
import type { ChatToolChoice, Diagnostic, Edits, ExpansionVariables, FenceFormat, GenerationOutput, LanguageModelInfo, LanguageModelReference, Logprob, PromptScript, SerializedError, WorkspaceFile } from "../types.js";
export interface ResponseStatus {
    ok: boolean;
    error?: SerializedError;
    status?: number;
}
export type OpenAIAPIType = "openai" | "azure" | "localai" | "azure_ai_inference" | "azure_serverless" | "azure_serverless_models" | "alibaba" | "huggingface" | "github";
export type AzureCredentialsType = "default" | "cli" | "env" | "powershell" | "devcli" | "managedidentity" | "workloadidentity";
...
export type RequestMessages = ServerKill | ServerEnv | ServerVersion | PromptScriptTestRun | PromptScriptStart | PromptScriptAbort | ChatChunk | LanguageModelConfigurationRequest | PromptScriptList | RunResultList;
export type PromptScriptResponseEvents = PromptScriptProgressResponseEvent | PromptScriptEndResponseEvent;
