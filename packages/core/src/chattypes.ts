...
export type ChatCompletionSystemMessageParam =
  OpenAI.Chat.Completions.ChatCompletionSystemMessageParam & ChatCompletionMessageParamCacheControl;

// Parameters for a tool message in a chat completion
export type ChatCompletionToolMessageParam =
  OpenAI.Chat.Completions.ChatCompletionToolMessageParam & ChatCompletionMessageParamCacheControl;
...
export type ChatCompletionUserMessageParam =
  OpenAI.Chat.Completions.ChatCompletionUserMessageParam & ChatCompletionMessageParamCacheControl;
