...
export const AZURE_AI_INFERENCE_TOKEN_SCOPES = Object.freeze(["https://ml.azure.com/.default"]);
...
export const GENAI_MDX_EXT = ".genai.mdx";
export const GENAI_ANYJS_GLOB = "**/*{.genai.js,.genai.mjs,.genai.ts,.genai.mts,.genai.mdx}";
export const NEGATIVE_GLOB_REGEX = /^!/;
export const GENAI_ANY_REGEX = /\.(genai\.(ts|mts|mjs|js|mdx)|prompty)$/i;
export const GENAI_ANYJS_REGEX = /\.genai\.js$/i;
export const GENAI_ANYTS_REGEX = /\.genai\.(ts|mts|mjs)$/i;
export const GENAI_MDX_REGEX = /\.genai\.mdx$/i;
...
export const FETCH_RETRY_MIN_DELAY_DEFAULT = 2000; // 2s
...
export const HUGGINGFACE_API_BASE = "https://router.huggingface.co/v1/";
export const GOOGLE_API_BASE = "https://generativelanguage.googleapis.com/v1beta/openai/";
export const ALIBABA_BASE = "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
...
export const DOCKER_MODEL_RUNNER_API_BASE = "http://model-runner.docker.internal/engines/v1/";
