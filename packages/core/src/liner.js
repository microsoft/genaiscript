 ...
 */
export function addLineNumbers(text, options) {
    ...
    if (startLine === 1 && lines.length < MIN_LINE_NUMBER_LENGTH)
        return text;
    return lines
 ...
 */
export function extractRange(text, options) {
 ...
 */
export function indexToLineNumber(text, index) {
