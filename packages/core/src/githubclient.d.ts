...
import type { BufferLike, Diagnostic, GitHub, GitHubArtifact, GitHubCodeSearchResult, GitHubComment, GitHubFile, GitHubGist, GitHubIssue, GitHubIssueUpdateOptions, GitHubLabel, GitHubOptions, GitHubPaginationOptions, GitHubPullRequest, GitHubReaction, GitHubReactionType, GitHubRef, GitHubRelease, GitHubWorkflow, GitHubWorkflowJob, GitHubWorkflowRun, GitHubWorkflowRunStatus, PromptScript, WorkspaceFile, GitHubIssueCreateOptions } from "./types.js";
...
export declare function githubCreateIssueComment(script: PromptScript, info: GithubConnectionInfo, body: string, commentTag: string, options?: CancellationOptions): Promise<{
    created: boolean;
    statusText: string;
    html_url?: string;
}>;
