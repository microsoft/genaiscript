...
export class AzureOpenAILanguageModel implements LanguageModel {
    readonly id = MODEL_PROVIDER_AZURE
    readonly completer: ChatCompletionHandler
    credential?: TokenCredential

    constructor() {
        this.completer = async (req, cfg, options, trace) => {
            const {
                temperature,
                top_p,
                seed,
