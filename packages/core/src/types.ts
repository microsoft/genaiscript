...
export type PromptOutputProcessorHandler = (
...
export type PromptTemplateResponseType =
  | "text"
  | "json"
  | "yaml"
  | "markdown"
...
export type ModelType = OptionsOrString<
  | "large"
  | "small"
  | "tiny"
  | "long"
...
export type EmbeddingsModelType = OptionsOrString<
...
export type ModelSmallType = OptionsOrString<
  | "openai:gpt-4o-mini"
  | "github:openai/gpt-4o-mini"
  | "azure:gpt-4o-mini"
  | "github:microsoft/phi-4"
...
export type ModelVisionType = OptionsOrString<
  "openai:gpt-4o" | "github:openai/gpt-4o" | "azure:gpt-4o" | "azure:gpt-4o-mini"
>;

export type ModelImageGenerationType = OptionsOrString<
  "openai:gpt-image-1" | "openai:dall-e-2" | "openai:dall-e-3"
>;

export type ModelProviderType = OptionsOrString<
  | "openai"
  | "azure"
  | "azure_serverless"
...
export type PromptJSONParameterType<T> = T & { required?: boolean };
 ...
 */
export interface DefDiffOptions
...
export interface DefDataOptions
...
export type ChatFunctionArgs = { context: ToolCallContext } & Record<string, any>;
...
export type ImportTemplateArgumentType =
...
export type TranscriptionModelType = OptionsOrString<
...
export type SpeechModelType = OptionsOrString<
  "openai:tts-1-hd" | "openai:tts-1" | "openai:gpt-4o-mini-tts"
>;

export type SpeechVoiceType = OptionsOrString<
  | "alloy"
  | "ash"
  | "coral"
  | "echo"
...
export type SgStrictness = "cst" | "smart" | "ast" | "relaxed" | "signature";
export interface SgPatternObject {
  context: string;
  selector?: string; //NamedKinds<M> // only named node types
  strictness?: SgStrictness;
}
export type SgPatternStyle = string | SgPatternObject;
...
export interface SgRelation extends SgRule {
  /**
...
export type McpServerToolResultPart =
