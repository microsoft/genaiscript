...
async function microsoftTeamsChannelUploadFile(
  ...
  options?: { folder?: string; disclaimer?: string } & TraceOptions & CancellationOptions,
 ...
 */
export function createMicrosoftTeamsChannelClient(url: string): MessageChannelClient {
  if (!url) url = process.env.GENAISCRIPT_TEAMS_CHANNEL_URL || process.env.GENAISCRIPT_TEAMS_URL;
