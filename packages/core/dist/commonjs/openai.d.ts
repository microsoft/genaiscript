...
import { EmbeddingResult } from "./chattypes.js";
 ...
 */
export declare function OpenAITranscribe(
 ...
 */
export declare function OpenAISpeech(
 ...
 */
export declare function OpenAIImageGeneration(
 ...
 */
export declare function LocalOpenAICompatibleModel(
  providerId: string,
  options: {
    listModels?: boolean;
    transcribe?: boolean;
