 ...
 */
class MemoryCache extends EventTarget {
    name;
    _entries;
    _pending;
    hashOptions;
    ...
    constructor(name) {
        ...
        this.name = name;
        this.dbg = (0, debug_1.default)(`genaiscript:cache:${name}`); // Initialize debugger
        this.hashOptions = {
    ...
    async set(key, val) {
        ...
        this.dispatchEvent(new Event(constants_js_1.CHANGE)); // Notify listeners
        this.dbg(`set ${sha}: updated`);
    }
    /**
