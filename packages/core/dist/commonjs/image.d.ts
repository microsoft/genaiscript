 ...
 */
export declare function imageTransform(
  url: BufferLike,
 ...
 */
export declare function imageEncodeForLLM(
  url: BufferLike,
 ...
 */
export declare function imageTileEncodeForLLM(
  urls: BufferLike[],
  options: DefImagesOptions & TraceOptions & CancellationOptions,
): Promise<{
  width: number;
 ...
 */
export declare function renderImageToTerminal(
  url: BufferLike,
  options: {
    columns: number;
    rows: number;
