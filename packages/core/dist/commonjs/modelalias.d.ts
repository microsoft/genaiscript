 ...
 */
export declare function applyModelProviderAliases(
  id: string,
 ...
 */
export declare function applyModelOptions(
  options: Partial<
 ...
 */
export declare function logModelAliases(options?: { all?: boolean }): void;
