...
export declare function agentCreateCache(
  options: Pick<GenerationOptions, "userState"> & {
    lookupOnly?: boolean;
  },
): AgentMemoryCache;
/**
 ...
 */
export declare function agentQueryMemory(
 ...
 */
export declare function agentAddMemory(
  cache: AgentMemoryCache,
  agent: string,
  query: string,
  text: string,
 ...
 */
export declare function traceAgentMemory(
