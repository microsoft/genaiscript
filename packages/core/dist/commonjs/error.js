...
exports.RequestError = exports.NotSupportedError = exports.CancelError = void 0;
...
const dbg = (0, debug_1.default)("genaiscript:error");
/**
...
function serializeError(e) {
    if (e === undefined || e === null)
        ...
        const err = (0, serialize_error_1.serializeError)(e, { maxDepth: 3, useToJSON: false });
 ...
 */
function errorMessage(e, defaultValue = "error") {
    if (e === undefined || e === null)
        return undefined;
    if (typeof e.messsage === "string")
        return e.message;
 ...
 */
function isRequestError(e, statusCode, code) {
