...
import { PromptImage, PromptPrediction } from "./promptdom.js";
 ...
 */
export declare function mergeGenerationOptions(
 ...
 */
export declare function executeChatSession(
 ...
 */
export declare function tracePromptResult(
  trace: MarkdownTrace,
  resp: {
    text?: string;
    reasoning?: string;
 ...
 */
export declare function appendUserMessage(
  messages: ChatCompletionMessageParam[],
 ...
 */
export declare function appendAssistantMessage(
  messages: ChatCompletionMessageParam[],
  content: string,
  options?: ContextExpansionOptions,
): void;
 ...
 */
export declare function appendSystemMessage(
  messages: ChatCompletionMessageParam[],
  content: string,
  options?: ContextExpansionOptions,
): void;
 ...
 */
export declare function addToolDefinitionsMessage(
  messages: ChatCompletionMessageParam[],
  tools: ToolCallback[],
): void;
