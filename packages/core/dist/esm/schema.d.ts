 ...
 */
export declare function JSONSchemaToFunctionParameters(
 ...
 */
export declare function JSONSchemaStringifyToTypeScript(
...
export declare function tryValidateJSONWithSchema<T = unknown>(
  object: T,
 ...
 */
export declare function validateJSONWithSchema(
  object: any,
  schema: JSONSchema,
  options?: {
    trace: MarkdownTrace;
 ...
 */
export declare function validateFencesWithSchema(
  fences: Fenced[],
 ...
 */
export declare function toStrictJSONSchema(
