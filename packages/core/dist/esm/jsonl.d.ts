 ...
 */
export declare function JSONLTryParse(text: string, options?: {
    repair?: boolean;
}): any[];
/**
 ...
 */
export declare function appendJSONL(name: string, objs: object | object[], meta?: any): Promise<void>;
export declare function createJSONL(): Readonly<JSONLObject>;
