 ...
 */
export function eraseAnnotations(text) {
 ...
 */
export function convertAnnotationsToItems(text) {
...
export function convertGithubMarkdownAnnotationsToItems(text) {
 ...
 */
export function convertAnnotationToItem(d) {
 ...
 */
export function convertDiagnosticToGitHubActionCommand(d) {
 ...
 */
export function convertDiagnosticToAzureDevOpsCommand(d) {
...
export function diagnosticToGitHubMarkdown(info, d) {
 ...
 */
export function convertAnnotationsToMarkdown(text) {
