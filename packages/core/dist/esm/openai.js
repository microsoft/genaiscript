...
import { AZURE_OPENAI_API_VERSION, MODEL_PROVIDER_AZURE_OPENAI, MODEL_PROVIDER_AZURE_SERVERLESS_MODELS, MODEL_PROVIDER_AZURE_SERVERLESS_OPENAI, } from "./constants.js";
...
export const OpenAIChatCompletion = async (req, cfg, options, trace) => {
    ...
    if (useResponsesApi)
        return OpenAIv2ResponsesChatCompletion(req, cfg, options, trace);
    else
        return OpenAIv1ChatCompletion(req, cfg, options, trace);
};
