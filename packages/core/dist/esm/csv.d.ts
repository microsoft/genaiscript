 ...
 */
export declare function CSVParse(
 ...
 */
export declare function CSVTryParse(
  text: string,
  options?: {
    delimiter?: string;
    headers?: ElementOrArray<string>;
 ...
 */
export declare function dataToMarkdownTable(
  csv: object[],
  options?: {
    headers?: ElementOrArray<string>;
  },
 ...
 */
export declare function headersToMarkdownTableSeperator(headers: string[]): string;
/**
 ...
 */
export declare function objectToMarkdownTableRow(
  row: object,
  headers: string[],
  options?: {
    skipEscape?: boolean;
 ...
 */
export declare function CSVChunk(
  rows: object[],
  size: number,
): {
