 ...
 */
export function prettyTokensPerSecond(usage) {
 ...
 */
export function prettyTokens(n, direction) {
    if (isNaN(n))
        return "";
...
export function prettyParenthesized(value) {
 ...
 */
export function prettyCost(value) {
 ...
 */
export function prettyStrings(...token) {
    const md = token.filter((l) => l !== undefined && l !== null && l !== "").join(", ");
    return md;
}
export function prettyValue(value, options) {
    if (isNaN(value))
        return "";
...
export function prettyTemperature(value) {
