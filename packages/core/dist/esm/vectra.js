 ...
 */
export const vectraWorkspaceFileIndex = async (indexName, cfg, embedder, options) => {
    ...
    logVerbose(`vectra search: ${indexName}, embedder ${cfg.provider}:${cfg.model}, ${vectorSize} dimensions`);
