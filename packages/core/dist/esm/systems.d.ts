 ...
 */
export declare function resolveSystems(prj: Project, script: PromptSystemOptions & ModelOptions & ContentSafetyOptions & {
    jsSource?: string;
}, resolvedTools?: ToolCallback[]): SystemPromptInstance[];
/**
 ...
 */
export declare function addFallbackToolSystems(systems: SystemPromptInstance[], tools: ToolCallback[], options?: ModelOptions, genOptions?: GenerationOptions): boolean;
/**
 ...
 */
export declare function resolveTools(prj: Project, systems: (string | SystemPromptInstance)[], tools: string[]): {
    id: string;
    description: string;
}[];
