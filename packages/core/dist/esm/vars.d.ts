 ...
 */
export declare function resolveScriptParametersSchema(
  prj: Project,
  script: PromptScript,
): JSONSchemaObject;
/**
 ...
 */
export declare function systemParameterToVarName(
 ...
 */
export declare function parsePromptParameters(
  prj: Project,
  script: PromptScript,
 ...
 */
export declare function mergeEnvVarsWithSystem(
