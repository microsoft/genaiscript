 ...
 */
export declare function createTextNode(
  value: Awaitable<string>,
...
export declare function createDef(
  name: string,
  file: WorkspaceFile,
 ...
 */
export declare function createDefDiff(
  name: string,
 ...
 */
export declare function createAssistantNode(
  value: Awaitable<string>,
  options?: ContextExpansionOptions,
): PromptAssistantNode;
/**
 ...
 */
export declare function createSystemNode(
  value: Awaitable<string>,
  options?: ContextExpansionOptions,
): PromptSystemNode;
/**
 ...
 */
export declare function createStringTemplateNode(
  strings: TemplateStringsArray,
  args: any[],
  options?: ContextExpansionOptions,
...
export declare function createFileImageNodes(
  name: string,
  file: WorkspaceFile,
 ...
 */
export declare function createSchemaNode(
  name: string,
  value: JSONSchema | ZodTypeLike,
  options?: DefSchemaOptions,
): PromptSchemaNode;
export declare function createToolNode(
  name: string,
  description: string,
  parameters: JSONSchema,
  impl: ChatFunctionHandler,
 ...
 */
export declare function createOutputProcessor(
  fn: PromptOutputProcessorHandler,
 ...
 */
export declare function createChatParticipant(
  participant: ChatParticipant,
...
export declare function createImportTemplate(
  files: ElementOrArray<string | WorkspaceFile>,
  args?: Record<string, ImportTemplateArgumentType>,
  options?: ImportTemplateOptions,
...
export declare function createDefData(
  name: string,
  value: Awaitable<object | object[]>,
 ...
 */
export declare function renderPromptNode(
  modelId: string,
  node: PromptNode,
 ...
 */
export declare function finalizeMessages(
  model: string,
  messages: ChatCompletionMessageParam[],
  options: {
    fileOutputs?: FileOutput[];
