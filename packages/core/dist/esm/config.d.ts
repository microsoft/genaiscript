...
import type { ResolvedLanguageModelConfiguration } from "./server/messages.js";
import type { CancellationOptions } from "./cancellation.js";
export declare function mergeHostConfigs(config: HostConfiguration, parsed: HostConfiguration): HostConfiguration;
/**
 ...
 */
export declare function readHostConfig(dotEnvPaths: string[], hostConfig: HostConfiguration): Promise<HostConfiguration>;
/**
 ...
 */
export declare function resolveLanguageModelConfigurations(provider: string, options?: {
    token?: boolean;
    error?: boolean;
    models?: boolean;
    hide?: boolean;
} & CancellationOptions): Promise<ResolvedLanguageModelConfiguration[]>;
