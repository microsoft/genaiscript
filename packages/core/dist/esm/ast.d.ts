...
export declare const eolPosition = 1073741823;
export declare const eofPosition: CharPosition;
/**
 ...
 */
export declare function collectFolders(
  prj: Project,
  options?: {
    force?: boolean;
  },
 ...
 */
export declare function filterScripts(
