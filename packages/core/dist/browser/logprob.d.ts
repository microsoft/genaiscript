 ...
 */
export declare function serializeChunkChoiceToLogProbs(choice: ChatCompletionChunkChoice): Logprob[];
/**
 ...
 */
export declare function logprobColor(logprob: Logprob, options?: {
    maxIntensity?: number;
    entropy?: boolean;
}): number;
/**
 ...
 */
export declare function logprobToMarkdown(value: Logprob, options?: {
    maxIntensity?: number;
    entropy?: boolean;
    eatSpaces?: boolean;
}): string;
 ...
 */
export declare function topLogprobsToMarkdown(value: Logprob, options?: {
    maxIntensity?: number;
}): string;
/**
