 ...
 */
export declare function importFile<T = void>(filename: string, options?: {
    onImported?: (module: any) => Awaitable<T>;
    logCb?: (msg: string) => void;
} & TraceOptions): Promise<T>;
/**
 ...
 */
export declare function importPrompt(ctx0: PromptContext, r: PromptScript, options?: {
    logCb?: (msg: string) => void;
