 ...
 */
export declare function diffCreatePatch(left: string | WorkspaceFile, right: string | WorkspaceFile, options?: {
    context?: number;
    ignoreCase?: boolean;
 ...
 */
export declare function diffFindChunk(file: string, range: number | [number, number], diff: ElementOrArray<DiffFile>): {
    file?: DiffFile;
    chunk?: DiffChunk;
} | undefined;
