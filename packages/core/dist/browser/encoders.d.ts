 ...
 */
export declare function resolveTokenEncoder(modelId: string, options?: {
 ...
 */
export declare function chunk(file: Awaitable<string | WorkspaceFile>, options?: TextChunkerConfig): Promise<TextChunk[]>;
