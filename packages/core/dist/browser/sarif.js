...
import { SARIFF_BUILDER_TOOL_DRIVER_NAME, SARIFF_BUILDER_URL, SARIFF_RULEID_PREFIX, } from "./constants.js";
 ...
 */
export function isSARIFFilename(f) {
 ...
 */
export async function convertDiagnosticsToSARIF(template, issues) {
