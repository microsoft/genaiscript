...
import { ANTHROPIC_MAX_TOKEN, MODEL_PROVIDER_ANTHROPIC, MODEL_PROVIDER_ANTHROPIC_BEDROCK, } from "./constants.js";
...
const convertAssistantMessage = (msg, emitThinking) => {
    return {
        ...
        content: [
            ...
            ...(msg.tool_calls || []).map((tool) => deleteUndefinedValues({
                type: "tool_use",
                id: tool.id,
...
export const AnthropicBedrockModel = Object.freeze({
    completer: completerFactory(async (trace, cfg, httpAgent, fetch) => {
