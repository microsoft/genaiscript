 ...
 */
export function resolveSystems(prj, script, resolvedTools) {
 ...
 */
export function addFallbackToolSystems(systems, tools, options, genOptions) {
    ...
    if (fallbackTools) {
        dbg(`adding fallback tools to systems`, deleteUndefinedValues({
            supported,
 ...
 */
export function resolveTools(prj, systems, tools) {
