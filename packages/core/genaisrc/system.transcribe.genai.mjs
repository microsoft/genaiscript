...
export default function (ctx) {
    ...
    defTool("transcribe", "Generate a transcript from a audio/video file using a speech-to-text model.", {
        filename: {
            type: "string",
            description: "Audio/video URL or workspace relative filepath",
        },
    }, function (args) { return __awaiter(_this, void 0, void 0, function () {
        var filename, _a, text, srt, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = _b.sent(), text = _a.text, srt = _a.srt, error = _a.error;
                    if (error)
                        return [2 /*return*/, error.message];
                    return [2 /*return*/, srt || text || "no response"];
            }
        });
    }); });
}
