...
export default function (ctx) {
    ...
    defTool("retrieval_fuzz_search", "Search for keywords using the full text of files and a fuzzy distance.", {
        type: "object",
        properties: {
            files: {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, retrieval.fuzzSearch(q, files.map(function (filename) { return ({ filename: filename }); }))];
                case 1:
                    res = _a.sent();
