...
of the city.`,
  ...
  test("JSONSchemaToFunctionParameters - anyOf types", () => {
    ...
    assert.strictEqual(JSONSchemaToFunctionParameters(schema), "string | number");
  });
  ...
  test("JSONSchemaToFunctionParameters - array type", () => {
    ...
    assert.strictEqual(JSONSchemaToFunctionParameters(schema), "{ string }[]");
  });
  ...
  test("JSONSchemaToFunctionParameters - object type", () => {
    ...
    assert.strictEqual(JSONSchemaToFunctionParameters(schema), "name: string, age?: number");
  });
