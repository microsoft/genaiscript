...
} from "../../runtime/src/copilotinstructions.js";
...
Use strict types.`,
    ...
    const instructions = await importCopilotInstructions(workspace as any, [
      "src/app.ts",
      "test.js",
    ]);
...
Write clean code.`,
    ...
    const instructions = await importCopilotInstructions(workspace as any, ["src/app.ts"], {
      includeGeneral: true,
    });
